  ...
  return (
    <>
      ...
      <div className="py-[2.5rem]">
        <SubContent SubContent="There are a couple of things to consider when preparing to apply typography to any interface." />
      </div>
      <SubText SubHeading="The Basics" height="38.5">
        {basicItems &&
          basicItems.map((basic) => {
            return (
              <div key={basic.title}>
                <SubContent
      ...
      <div className="pt-[2.5rem]">
        <SubText
          ...
          height="61.5"
        >
          <SubContent SubContent="A modular type scale can be generated using harmonious values like the golden ratio, the major third, the perfect fifth, and so on." />
          <div className="py-[1.5rem] bg-gray-500"></div>
          <SubContent SubContent="Because of the progressive increase or decrease that governs the content of a type scale, it makes it easier to obtain consistent, related, and harmonious font sizes that can each be used for specific needs when curating digital interfaces." />
        </SubText>
      </div>

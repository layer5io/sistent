  ...
  return (
    <FooterWrapper>
      <Col xs={9} className="container">
        <Row>
          <Col xs={4} className="text about">
            <Col xs={2}>
              <img src={SistentLogo} alt="Sistent logo" />
            </Col>
            <Col>
              Sistent is a flexible system of guidelines, components, and tools that highlight best
              practices of user interface design. Supported by open-source code, Sisten Design
              System demistifies collaboration between designers and developers making the workflow
              seamless and enabling teams to create beautiful solutions.
            </Col>
          </Col>
          <Col xs={1}>
            <ul className="links">
          ...
          <Col xs={2} className="text">
            Any questions? Email us at community@layer5.io or open an issue on GitHub.
          </Col>
        </Row>
      </Col>
    </FooterWrapper>

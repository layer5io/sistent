...
export const ConfigurationIcon: FC<ConfigurationIconProps> = ({
  width = DEFAULT_WIDTH,
  ...
  return (
    ...
    >
      ...
      <path
        fill={fill}
        d="M39.28,29.52a1,1,0,0,0,1.41,0l7.46-7.45c9,2.57,15.59-8.52,9-15.21s-17.75,0-15.19,9l-7.47,7.47a1,1,0,0,0,0,1.41ZM45.84,14.1l1-3.88a1,1,0,0,1,.71-.71l3.88-1a1,1,0,0,1,1,.26l2.84,2.84a1,1,0,0,1,.26,1l-1,3.88a1,1,0,0,1-.71.71l-3.88,1a1.07,1.07,0,0,1-.25,0,1,1,0,0,1-.71-.29L46.1,15.06A1,1,0,0,1,45.84,14.1ZM24.72,34.48a1,1,0,0,0-1.41,0L15.84,42c-9-2.56-15.56,8.5-9,15.19s17.79,0,15.19-9l7.47-7.47a1,1,0,0,0,0-1.41Zm-7.23,15.6-.86,3.21a1,1,0,0,1-.71.71l-3.21.86a1,1,0,0,1-1-.26L9.4,52.25a1,1,0,0,1-.26-1L10,48.08a1,1,0,0,1,.71-.71l3.21-.86a1,1,0,0,1,1,.26l2.35,2.35A1,1,0,0,1,17.49,50.08Z"
      />
    </svg>
  );
};

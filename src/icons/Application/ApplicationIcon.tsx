/** @TODO Review the fill colors, because it is different than ApplicationOutlineIcon */
import { styled } from '@mui/material/styles';
import { CARIBBEAN_GREEN_FILL, CHARCOAL_FILL, KEPPEL_GREEN_FILL } from '../../constants/constants';
...
const StyledSistentIcon = styled(SistentIcon, {
  name: 'ApplicationIcon',
  slot: 'Root',
  overridesResolver: (props, styles) => [
    styles.root,
    props.keppelColors && { '& path:nth-of-type(1)': { fill: KEPPEL_GREEN_FILL } },
    props.keppelColors && { '& path:nth-of-type(3)': { fill: KEPPEL_GREEN_FILL } },
    props.keppelColors && { '& path:nth-of-type(2)': { fill: CARIBBEAN_GREEN_FILL } }
  ]
...
function ApplicationIcon({
  primaryFill = CHARCOAL_FILL,
  secondaryFill = CHARCOAL_FILL,
  keppelColors = false,
  ...props
}: ApplicationIconProps): React.JSX.Element {
  const primaryColor = keppelColors ? KEPPEL_GREEN_FILL : primaryFill;
  const secondaryColor = keppelColors ? CARIBBEAN_GREEN_FILL : secondaryFill;
